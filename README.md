...
- **Резервное копирование** — скачать/восстановить архив с базами
  ...
  суффиксом `.before-restore`

## Поддерживаемые модели телефонов (провижининг)

Автопровижининг поддерживает телефоны Grandstream:
...
Телефоны других производителей (Yealink, Fanvil и т.п.) сейчас не
поддерживаются — под них нет шаблонов конфигурации.
